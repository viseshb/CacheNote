...
namespace StickyDesk.Core.DependencyInjection;

/// <summary>Registers all UI-agnostic StickyDesk services (data, settings, paths).</summary>
public static class CoreServiceCollectionExtensions
{
    private static bool _dapperConfigured;

    public static IServiceCollection AddStickyDeskCore(this IServiceCollection services)
    {
        ConfigureDapper();
