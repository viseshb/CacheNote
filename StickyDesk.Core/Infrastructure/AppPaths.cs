namespace StickyDesk.Core.Infrastructure;

/// <summary>
/// Single source of truth for every on-disk location StickyDesk uses.
...
public sealed class AppPaths : IAppPaths
{
    public AppPaths(string? rootOverride = null)
    {
        ...
        DatabaseFile = Path.Combine(DataDir, "stickydesk.db");
