...
/// Set <c>STICKYDESK_NO_SINGLE_INSTANCE=1</c> to bypass; the UI test harness does this because
...
public static class Program
{
    ...
    private static bool SingleInstanceBypassed() =>
        Environment.GetEnvironmentVariable("STICKYDESK_NO_SINGLE_INSTANCE") == "1";

    private static bool RedirectedToExistingInstance()
    {
        var activationArgs = AppInstance.GetCurrent().GetActivatedEventArgs();
        var main = AppInstance.FindOrRegisterForKey("StickyDesk-9F3C-SingleInstance");
